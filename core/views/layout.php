        ...
        <div class="row">
          <div class="footer-four col-lg-4 col-md-4 col-sm-12 col-xs-12 column">
            <div class="block-title">
              <span> Đỗ Ngọc Đông (Trưởng nhóm) </span>
            </div>
            <div class="block-container">
              <div> Cẩm Giàng, Hải Dương </div>
              <div> Điện thoại: 0398862526 </div>
              <a class="link-info link-offset-2 link-underline-opacity-25 link-underline-opacity-100-hover" href="https://www.facebook.com/ngocdong2110.2003" target="_blank"> Facebook </a>
            </div>
          </div>

          <div class="footer-four col-lg-4 col-md-4 col-sm-12 col-xs-12 column">
            <div class="block-title">
              <span> Nguyễn Duy Tuấn </span>
            </div>
            <div class="block-container">
              <div> Hà Đông, Hà Nội </div>
              <div> Điện thoại: 0398862526 </div>
              <a class="link-info link-offset-2 link-underline-opacity-25 link-underline-opacity-100-hover" href="https://www.facebook.com/profile.php?id=100008520241649" target="_blank"> Facebook </a>
            </div>
          </div>
          ...
          <div class="footer-four col-lg-4 col-md-4 col-sm-12 col-xs-12 column">
            ...
            <div class="block-container">
              <div> Hà Đông, Hà Nội </div>
              <div> Điện thoại: 0398862526 </div>
              <a class="link-info link-offset-2 link-underline-opacity-25 link-underline-opacity-100-hover" href="https://www.facebook.com/jiro.kazune" target="_blank"> Facebook </a>
            </div>
          </div>
        </div>
      </div>
